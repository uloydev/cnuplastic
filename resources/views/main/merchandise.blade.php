...
.konten-produk1 h6{
    ...
    .kategori-produk .container .kategori{
      margin-top: 15px;
      margin-left: -90px;
      
    }
  	.kategori-produk .cari input{
  		width: 400px;
  	}
    .kategori-produk .container .col-sm-9{
      margin-top: 20px;
    }
  	...
  	.kategori-produk .produk .col-md-3{
  		margin:-10px;
  		margin-top: 0px;
  		margin-bottom: 10px;
  		margin-left: 10px;
  	...
  	.kategori-produk .produk  .container{
  		padding: 0px;
  	}
  	.kategori-produk .produk .container .row{
  		padding: 0px;
  	}
  	.kategori-produk .row .judul p{
  		font-family: Roboto;
  		font-weight: 600;
  		margin-top: 10px;
  		font-size: 18px;
  	}
  	.kategori-produk .row .judul1{
...
<body>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><img src="assets/image/jempol.png" width="130px"></a>
...
<div class="kategori-produk">
	<div class="container">
		<div class="row">
			<div class="col-sm-3">
				<div class="kategori">
					...
					<div class="ul"><h6>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="assets/image/dot.png" width="30px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Event Category</h6>
					<ul>
        ...
        <button class="btn btn-outline-success" type="submit">Search</button>
				...
				<div class="judul"><p>All Product</p></div>
					<div><p class="judul1">8 items</p>
				</div>
				<div class="produk">
					<div class="container">
  <div class="row">
...
<div class="modal fade" id="produk1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="assets/image/laptop.jpg" class="d-block w-100" alt="...">
    </div>
  ...
  <img src="laptop.jpg" class="detailgambar">
  <img src="laptop.jpg" class="detailgambar">
  <img src="laptop.jpg" class="detailgambar">
</div>
            </div>
            <div class="col-md-6"> 
                ...
                <h4>Rp 30.000</h4>
                <p class="garis">_______________________________________________</p>
                ...
                <p class="garis">_______________________________________________</p>
                <a href=""><img src="assets/image/toko.png" class="profil"></a>
                <a href=""><p class="toko">Boy Style<br>
                    <span>Ghani Fadillah</span></p></a>
                <a href=""><img src="assets/image/wa.png" class="wa"></a>
              </div>
            </div>
        </div>  
      </div>
  ...
  </div>file:///C:/Users/ASUS%20PC/Downloads/jempol/merchandise.html#
</div>
</div>
<!--detail-->
...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-3">
      <div class="gambar">
        &nbsp;&nbsp;&nbsp;&nbsp;<img src="assets/image/bidang1.png" width="100px">
        <img src="assets/image/x.png" width="30px">
        <img src="assets/image/bidang2.png" width="100px;" >
...
<div class="container">
  <div class="row">
    <div class="col-sm-12">
      <p>Copyright 2021 Design All Right Reserved. Powered by Developer BEM UPNVJ</p>
